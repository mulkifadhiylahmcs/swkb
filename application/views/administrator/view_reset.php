...
<html>
  <head>
    ...
    <meta name="author" content="gatra.com">
    <!-- Tell the browser to be responsive to screen width -->
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
    <!-- Bootstrap 3.3.5 -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>/asset/admin_mu/bootstrap/css/bootstrap.min.css">
    <!-- Font Awesome -->
  ...
  <body class="hold-transition login-page">
    ...
    <!-- Bootstrap 3.3.5 -->
    <script src="<?php echo base_url(); ?>/asset/admin_mu/bootstrap/js/bootstrap.min.js"></script>
    <!-- iCheck -->
